package com.video.process.compose.audio;
...
public class Pcm2Wav {
    ...
    public Pcm2Wav() {
        this.mBufferSize =
                AudioRecord.getMinBufferSize(mSampleRate, mChannelConfig, mEncoding);
    }
     ...
     */
    public Pcm2Wav(int sampleRate, int channelConfig, int channelCount,
                        int encoding) {
     ...
     */
    public void doPcm2Wav(String inFilename, String outFilename) {
        FileInputStream in;
